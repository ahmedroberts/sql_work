...
CREATE DATABASE [WiredBrainCoffee]
 ON PRIMARY 
 -- C:\Projects\sql_work\ -- for queries and such
-- ============================== Raikage File Locaton =======================================================================================
( NAME = N'WiredBrainCoffee', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SUPERSQLSERVER\MSSQL\DATA\WiredBrainCoffee.mdf' ,SIZE = 100000KB , FILEGROWTH = 100000KB)
 LOG ON 
( NAME = N'WiredBrainCoffee_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SUPERSQLSERVER\MSSQL\DATA\WiredBrainCoffee_log.ldf',SIZE = 100000KB , FILEGROWTH = 100000KB)

-- ============================== Original File Locaton =======================================================================================
